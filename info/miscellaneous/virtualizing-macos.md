...
2. Update: Open App Store and select `Updates`. Update macOS \(this may take a while\). Note: iTunes was discontinued in macOS Catalina (2019); Finder now handles device management on modern macOS.
