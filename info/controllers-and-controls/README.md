...
**[Supported Controllers](controllers/README.md)** — Full compatibility guide covering:
...
**[Controller Reviews](controllers/controller-reviews.md)** — Individual reviews with pros, cons, and recommendations to help you choose the right controller.

## 🗺 Control Maps

**[Control Maps](control-maps.md)** — Button mappings for every supported system, organized by MFi gamepad profile (Micro, Standard, Extended, Extended2).
