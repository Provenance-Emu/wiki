---
description: "New to emulation? Here's what it is, why you want it, and what you can play — explained for everyone."
---
...
**Next step:** [Getting Started →](../installation-and-usage/getting-started.md)
{% endtab %}
...
- Had a PlayStation → grab some PS1 BIOS files first → [BIOS Requirements](../installation-and-usage/bios-requirements.md)
...
{% tab title="I know what I'm doing" %}
You're here for one reason. Skip the tour:

- [Install from App Store](../installation-and-usage/installing-provenance/app-store.md)
