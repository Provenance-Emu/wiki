...
{% hint style="info" %}
**Auto-generated** from [Provenance source code](https://github.com/Provenance-Emu/Provenance) on June 08, 2026. Do not edit manually — changes will be overwritten by the [sync workflow](https://github.com/Provenance-Emu/wiki/actions/workflows/sync-from-source.yml).
{% endhint %}
