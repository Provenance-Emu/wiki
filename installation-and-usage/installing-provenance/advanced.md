...
**Most users should use the [App Store](app-store.md)** - it's easiest and updates automatically.
...
[📖 Full Sideloading Guide →](sideloading.md)
...
[📖 Full Building Guide →](building-from-source.md)
...
[See backup guide →](../../info/miscellaneous/restoring-files.md)

---

## Recommendation

**For 90% of users:** Use the **[App Store version](app-store.md)**
- Easiest installation
- Automatic updates
- Official support
- Optional Plus features

**For power users:** Try **[sideloading](sideloading.md)** if you want free alternative

**For developers:** **[Build from source](building-from-source.md)** to contribute or customize
...
**Choose your method:**
- [📱 App Store Installation](app-store.md) - Recommended for most users
- [🔧 Sideloading Guide](sideloading.md) - Free alternative
- [💻 Building from Source](building-from-source.md) - Developers

**After installation:**
- [Import ROMs](../roms/importing-roms.md)
- [BIOS Requirements](../bios-requirements.md)
- [Controller Setup](../../info/controllers-and-controls/)
