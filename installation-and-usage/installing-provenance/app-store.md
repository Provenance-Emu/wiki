...
- [Sideload](sideloading.md) using AltStore (no region restrictions)
- [Build from source](building-from-source.md) (developers)
...
**After installing:**
1. [Import ROMs](../roms/importing-roms.md) - Add games to your library
2. [BIOS Requirements](../bios-requirements.md) - Some systems need BIOS files
3. [Controllers](../../info/controllers-and-controls/) - Connect a gamepad for best experience
...
{% hint style="info" %}
Need help? Check the [Troubleshooting Guide](../../help/troubleshooting.md) or ask on [Discord](https://discord.gg/provenance).
{% endhint %}
